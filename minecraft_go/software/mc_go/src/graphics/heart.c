...
void heart_erase(int x, int y, int width) {
	int pixelSize = width / HEART_PIXEL_WIDTH;
	graphics_draw_rectangle_filled(x, y, pixelSize*HEART_PIXEL_WIDTH, pixelSize*HEART_PIXEL_HEIGHT, GRAPHICS_BACKGROUND_COLOUR);
}
...
static void heart_generator(int x, int y, int pixelSize) {
	...
	int heartColours[HEART_PIXEL_HEIGHT][HEART_PIXEL_WIDTH] = {
